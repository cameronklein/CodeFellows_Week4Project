...
class RevealViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate
{
    ...
    override func viewDidLoad(){
      ...
      for player in gameController.game.players {
        ...
        {
          self.flavorTextLabel.typeToNewString("Congratulations on successfully infiltrating the hacker cell, agent. Work with your team to protect the regime and the status quo. Protect your true identity, allow yourself to be sent on missions, and ensure that three missions fail. Good luck.", withInterval: 0.05)
        }
        else
        {
          self.flavorTextLabel.typeToNewString("The time has come. Fully loyal to the hacker cause, you will do anything you can to bring down the oppressive government regime. Bad news, though. Trustworthy intel has indicated that the government has \(agentArray.count) spies in the group. Sniff them out and ensure that three missions succeed.", withInterval: 0.05)
        }
    }
